...
function checkerrorCode39(code){
  for (let i=0;i<code.length;i++)
  {
    ...
    if (!((code.charCodeAt(i)>='0' &&code.charCodeAt(i)<='9') || (code.charCodeAt(i)>='A' && code.charCodeAt(i)<='Z') || code.charCodeAt(i)=='-' || code.charCodeAt(i)=='.'|| code.charCodeAt(i)=='$'|| code.charCodeAt(i)=='/'|| code.charCodeAt(i)=='+'|| code.charCodeAt(i)=='%'|| code.charCodeAt(i)==' '))
    {
